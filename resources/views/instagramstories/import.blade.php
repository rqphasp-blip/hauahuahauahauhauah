                ...
                <div class="card-body">
                    ...
                    @if (session('import_log'))
                        <div class="alert alert-secondary" role="alert">
                            <strong>Log do processo de importação:</strong>
                            <pre class="mb-0 mt-2" style="white-space: pre-wrap; word-break: break-word;">{{ implode("\n", session('import_log')) }}</pre>
                        </div>
                    @endif
                    ...
                    <form method="POST" action="{{ route('stories.instagram.store') }}">
                        ...
                        <div class="alert alert-info">
                            O story (imagem ou vídeo) importado será salvo no mesmo gerenciador e ficará visível por 24 horas, assim como os stories enviados manualmente.
                        </div>
